...
4. Within ```<div class="albumstash">``` add divs with the class <i>photostash</i> or change the existing ones. Adjust the id to the title of the objects. However, write the id in lower case and remove spaces.
